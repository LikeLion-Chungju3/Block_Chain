    ...
    <div id ="gameBoard">
      <div class="event">
        ...
        <div>
          ...
          <div id="walletAccount">{{ walletAccount }}</div>
        </div>
        <div>
          <button @click="onClickMyNfts()">내 NFT 수 조회</button>
          <span id="myNfts">{{ myNfts }}</span>
        </div>
        <button @click="onClickMint()">민팅하기</button>
...
<script src = "https://cdnjs.cloudflare.com/ajax/libs/web3/1.8.1/web3.min.js"></script>
  ...
  created() {
	...
	},
	{
      ...
      "0xc64580C02dDFB88252e84087846a838243360f12"
    );
